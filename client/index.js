  ...
  fetch('/api/tasks')
    ...
    .then((response) => {
      response.forEach((task) => {
        ...
        actions.innerHTML = `<button class="button is-small is-primary is-danger" id="deleteTask${task.id}" onclick="completeTask('${task.id}');"><span class="icon is-small"><i class="fa fa-trash"></i></span></button>`
